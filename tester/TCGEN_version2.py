...
LED Values Match Expected
    [Arguments]     ${expected_led_values}
...
Test Case ${ADC_value}
    ...
    Wait Until Keyword Succeeds    ${LED_TIMEOUT}    ${LED_POLL_INTERVAL}    LED Values Match Expected    ${expected_led_values}
"""
