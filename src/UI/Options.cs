...
namespace Antmicro.Renode.UI
{
    public class Options : IValidatedOptions
    {
        ...
        // hrkim add
        [Name("fmi"), DefaultValue(-1), Description("Port number for FMI mode")]
        public int FMIPort { get; set; }     

        // hrkim add
        [Name("resc"), DefaultValue(""), Description("Input resc file path")]       
        public string rescPath {get; set;}
