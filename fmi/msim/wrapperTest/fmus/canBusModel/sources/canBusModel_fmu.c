...
void fmu_LogOutput(void) {
    FMUModelData *modelData = (FMUModelData *)_instance;
    strncpy(modelData->sOutput[0], modelData->sList[4], modelData->sSize[4]);
}
void fmu_RestoreOutput(void) {
    FMUModelData *modelData = (FMUModelData *)_instance;
    strncpy(modelData->sList[4], modelData->sOutput[0], modelData->sSize[4]);
}
...
fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType, fmi2String fmuGUID,
    ...
    if (!functions->logger) {
        ...
        return NULL;
    } else if (strcmp(fmuGUID, "{972d16a0-be2a-0480-896d-976e8f6630c5}")) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Wrong GUID %s. Expected %s.", fmuGUID, "{972d16a0-be2a-0480-896d-976e8f6630c5}");
        return NULL;
    }
    ...
    modelData->sList = (char**)calloc(5, sizeof(char*));
    if (!modelData->sList) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    }
    modelData->sSize = (int32_T*)calloc(5, sizeof(int32_T));
    if (!modelData->sSize) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    ...
    modelData->sList[4] = canBusModel_Y.CAN_OUT;
