...
void fmu_LogOutput(void) {
    FMUModelData *modelData = (FMUModelData *)_instance;
    strncpy(modelData->sOutput[0], modelData->sList[72], modelData->sSize[72]);
}
void fmu_RestoreOutput(void) {
    FMUModelData *modelData = (FMUModelData *)_instance;
    strncpy(modelData->sList[72], modelData->sOutput[0], modelData->sSize[72]);
}
...
fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType, fmi2String fmuGUID,
    ...
    if (!functions->logger) {
        ...
        return NULL;
    } else if (strcmp(fmuGUID, "{4fdf173f-6938-1450-7f01-e144da4f569e}")) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Wrong GUID %s. Expected %s.", fmuGUID, "{4fdf173f-6938-1450-7f01-e144da4f569e}");
        return NULL;
    }
    ...
    modelData->sList = (char**)calloc(73, sizeof(char*));
    if (!modelData->sList) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    }
    modelData->sSize = (int32_T*)calloc(73, sizeof(int32_T));
    if (!modelData->sSize) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    ...
    modelData->sList[72] = canBusModel_Y.CAN_OUT;
