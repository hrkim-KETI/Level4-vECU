...
void fmu_LogOutput(void) {
    FMUModelData *modelData = (FMUModelData *)_instance;
    strncpy(modelData->sOutput[0], modelData->sList[64], modelData->sSize[64]);
}
void fmu_RestoreOutput(void) {
    FMUModelData *modelData = (FMUModelData *)_instance;
    strncpy(modelData->sList[64], modelData->sOutput[0], modelData->sSize[64]);
}
...
fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType, fmi2String fmuGUID,
    ...
    if (!functions->logger) {
        ...
        return NULL;
    } else if (strcmp(fmuGUID, "{85d8f9c9-3c78-ffea-14dc-5bf920617807}")) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Wrong GUID %s. Expected %s.", fmuGUID, "{85d8f9c9-3c78-ffea-14dc-5bf920617807}");
        return NULL;
    }
    ...
    modelData->sList = (char**)calloc(65, sizeof(char*));
    if (!modelData->sList) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    }
    modelData->sSize = (int32_T*)calloc(65, sizeof(int32_T));
    if (!modelData->sSize) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    ...
    modelData->sList[64] = canBusModel_Y.CAN_OUT;
