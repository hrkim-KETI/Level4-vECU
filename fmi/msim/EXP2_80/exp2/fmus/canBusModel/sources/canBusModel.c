...
void canBusModel_step(void)
{
  ...
  rtb_Decode_o4 = 0;
  y4_1z[0] = '\x00';
  sscanf(&canBusModel_U.CAN_IN_73[0], "%d-%d-%d-%d-%s", &rtb_Decode_o1,
         &rtb_Decode_o2, &rtb_Decode_o3, &rtb_Decode_o4, &y4_1z[0]);
  strncpy((char_T *)&rtb_StringtoASCII[0], &y4_1z[0], 200U);
  fmu_can_arbitration(rtb_Decode_o1, rtb_Decode_o2, rtb_Decode_o3, rtb_Decode_o4,
                      &rtb_StringtoASCII[0]);
  rtb_Decode_o1 = 0;
  rtb_Decode_o2 = 0;
  ...
  rtb_Decode_o4 = 0;
  y4_20[0] = '\x00';
  sscanf(&canBusModel_U.CAN_IN_74[0], "%d-%d-%d-%d-%s", &rtb_Decode_o1,
         &rtb_Decode_o2, &rtb_Decode_o3, &rtb_Decode_o4, &y4_20[0]);
  strncpy((char_T *)&rtb_StringtoASCII[0], &y4_20[0], 200U);
  fmu_can_arbitration(rtb_Decode_o1, rtb_Decode_o2, rtb_Decode_o3, rtb_Decode_o4,
                      &rtb_StringtoASCII[0]);
  rtb_Decode_o1 = 0;
  rtb_Decode_o2 = 0;
  ...
  rtb_Decode_o4 = 0;
  y4_21[0] = '\x00';
  sscanf(&canBusModel_U.CAN_IN_75[0], "%d-%d-%d-%d-%s", &rtb_Decode_o1,
         &rtb_Decode_o2, &rtb_Decode_o3, &rtb_Decode_o4, &y4_21[0]);
  strncpy((char_T *)&rtb_StringtoASCII[0], &y4_21[0], 200U);
  fmu_can_arbitration(rtb_Decode_o1, rtb_Decode_o2, rtb_Decode_o3, rtb_Decode_o4,
                      &rtb_StringtoASCII[0]);
  rtb_Decode_o1 = 0;
  rtb_Decode_o2 = 0;
  ...
  rtb_Decode_o4 = 0;
  y4_22[0] = '\x00';
  sscanf(&canBusModel_U.CAN_IN_76[0], "%d-%d-%d-%d-%s", &rtb_Decode_o1,
         &rtb_Decode_o2, &rtb_Decode_o3, &rtb_Decode_o4, &y4_22[0]);
  strncpy((char_T *)&rtb_StringtoASCII[0], &y4_22[0], 200U);
  fmu_can_arbitration(rtb_Decode_o1, rtb_Decode_o2, rtb_Decode_o3, rtb_Decode_o4,
                      &rtb_StringtoASCII[0]);
  rtb_Decode_o1 = 0;
  rtb_Decode_o2 = 0;
  ...
  rtb_Decode_o4 = 0;
  y4_23[0] = '\x00';
  sscanf(&canBusModel_U.CAN_IN_77[0], "%d-%d-%d-%d-%s", &rtb_Decode_o1,
         &rtb_Decode_o2, &rtb_Decode_o3, &rtb_Decode_o4, &y4_23[0]);
  strncpy((char_T *)&rtb_StringtoASCII[0], &y4_23[0], 200U);
  fmu_can_arbitration(rtb_Decode_o1, rtb_Decode_o2, rtb_Decode_o3, rtb_Decode_o4,
                      &rtb_StringtoASCII[0]);
  rtb_Decode_o1 = 0;
  rtb_Decode_o2 = 0;
  ...
  rtb_Decode_o4 = 0;
  y4_24[0] = '\x00';
  sscanf(&canBusModel_U.CAN_IN_78[0], "%d-%d-%d-%d-%s", &rtb_Decode_o1,
         &rtb_Decode_o2, &rtb_Decode_o3, &rtb_Decode_o4, &y4_24[0]);
  strncpy((char_T *)&rtb_StringtoASCII[0], &y4_24[0], 200U);
  fmu_can_arbitration(rtb_Decode_o1, rtb_Decode_o2, rtb_Decode_o3, rtb_Decode_o4,
                      &rtb_StringtoASCII[0]);
  rtb_Decode_o1 = 0;
  rtb_Decode_o2 = 0;
  ...
  rtb_Decode_o4 = 0;
  y4_25[0] = '\x00';
  sscanf(&canBusModel_U.CAN_IN_79[0], "%d-%d-%d-%d-%s", &rtb_Decode_o1,
         &rtb_Decode_o2, &rtb_Decode_o3, &rtb_Decode_o4, &y4_25[0]);
  strncpy((char_T *)&rtb_StringtoASCII[0], &y4_25[0], 200U);
  fmu_can_arbitration(rtb_Decode_o1, rtb_Decode_o2, rtb_Decode_o3, rtb_Decode_o4,
                      &rtb_StringtoASCII[0]);
  rtb_Decode_o1 = 0;
  rtb_Decode_o2 = 0;
  ...
  rtb_Decode_o4 = 0;
  y4_26[0] = '\x00';
  sscanf(&canBusModel_U.CAN_IN_80[0], "%d-%d-%d-%d-%s", &rtb_Decode_o1,
         &rtb_Decode_o2, &rtb_Decode_o3, &rtb_Decode_o4, &y4_26[0]);
  strncpy((char_T *)&rtb_StringtoASCII[0], &y4_26[0], 200U);
  fmu_can_arbitration(rtb_Decode_o1, rtb_Decode_o2, rtb_Decode_o3, rtb_Decode_o4,
                      &rtb_StringtoASCII[0]);
