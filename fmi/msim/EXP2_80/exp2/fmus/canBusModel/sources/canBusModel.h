...
typedef struct {
  ...
  char_T CAN_IN_73[256];
  char_T CAN_IN_74[256];
  char_T CAN_IN_75[256];
  char_T CAN_IN_76[256];
  char_T CAN_IN_77[256];
  char_T CAN_IN_78[256];
  char_T CAN_IN_79[256];
  char_T CAN_IN_80[256];
} ExtU_canBusModel_T;
