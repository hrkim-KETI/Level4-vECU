...
fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType, fmi2String fmuGUID,
    ...
    if (!functions->logger) {
        ...
        return NULL;
    } else if (strcmp(fmuGUID, "{58bbd77e-b2bc-5452-e1fc-57647047c7bd}")) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Wrong GUID %s. Expected %s.", fmuGUID, "{58bbd77e-b2bc-5452-e1fc-57647047c7bd}");
        return NULL;
    }
    ...
    modelData->iList = (int32_T**)calloc(2, sizeof(int32_T*));
    if (!modelData->iList) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    ...
    modelData->iList[0] = &(vECUcontroller_P.fmuNum);
    modelData->iList[1] = &(vECUcontroller_P.portVal);
    fmu_syncToBuffer();
